...
function validateForm() {
  ...
  if (!nameValue) {
    setFieldError(invoiceNameInput, "invoiceName", "Vui lòng nhập tên hóa đơn.");
    isValid = false;
  } else {
  ...
  if (!typeValue) {
    setFieldError(invoiceTypeInput, "invoiceType", "Vui lòng chọn loại hóa đơn.");
    isValid = false;
  } else {
  ...
  if (!dateValue) {
    setFieldError(createdDateInput, "createdDate", "Vui lòng chọn ngày tạo hóa đơn.");
    isValid = false;
  } else {
