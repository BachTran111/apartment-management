...
class DashboardService {
    ...
    static async getStats() {
        ...
        const [totalRooms, occupiedRooms, totalTenants, revenueResult] = await Promise.all([
    ...
    static async getChartData() {
        ...
        for (let i = 5; i >= 0; i--) {
            ...
            const record = revenueData.find(
                (r) => r._id.month === d.getMonth() + 1 && r._id.year === d.getFullYear()
            );
    ...
    static async getRecentActivities() {
        ...
        return activities.map((bill) => ({
            ...
            date: bill.ngay_lap ? new Date(bill.ngay_lap).toISOString().split('T')[0] : 'N/A',
            amount: bill.so_tien,
